import cv2
import cvui
rtsp_username = "Name" # Enter your Name
rtsp_password = "CCTV Password" # Enter your password
width = 800
height = 480
cam_no = 1
def create_camera (channel):
    rtsp = "rtsp://" + rtsp_username + ":" + rtsp_password + "@192.168.1.34:554/Streaming/channels/" + channel + "02"
